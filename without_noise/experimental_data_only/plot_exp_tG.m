...
errorbar( t , y , z/sqrt(8), 'vertical','o','linewidth',1,'color','b','CapSize',10,'markersize',5,'markerfacecolor','b');
y=y'; y(3)=[];t(3)=[]; 
ymax=0.295;
...
errorbar( t , y , z/sqrt(8), 'vertical','o','linewidth',1,'color','r','CapSize',10,'markersize',5,'markerfacecolor','r');
y=y'; y(3)=[];t(3)=[]; 
ymax=0.0231;
p=polyfit(t,log(ymax-y),1);
